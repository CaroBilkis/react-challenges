...
import NavigationBlack from "../components/NavigationBlack";
...
function Intro() {
    ...
    const [featuresL, setFeaturesL] = useState(false);
    const controlFeaturesL = () => {
        setFeaturesL(!featuresL);
    }

    const [companyL, setCompanyL] = useState(false);
    const controlCompanyL = () => {
        setCompanyL(!companyL);
    }
  return (
    ...
    <div className={'font-epilogue h-screen  mx-auto bg-almost-white  px-4 '}>
        ...
        <div className=''>
            ...
            <div className='md:flex flex-row gap-8 sm:hidden hidden   '>
            <button onClick={()=>controlFeatures()}  className='flex flex-row gap-3 items-center text-sm font-medium text-almost-gray hover:text-black' >Features 
          {features ?<svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg> :  <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>}
            </button> 
            <button onClick={()=>controlCompany()}  className='flex flex-row gap-3 items-center text-sm font-medium text-almost-gray hover:text-black'>Company
            {company ?<svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg> :  <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>}
            </button>
            <button className='text-sm font-medium  text-almost-gray hover:text-black' >Careers</button>
            <button className='text-sm font-medium text-almost-gray hover:text-black'>About</button>
            </div>
        </div>

            <div className='md:flex flex-row gap-8 sm:hidden hidden'>
            <button className='text-sm font-medium text-almost-gray hover:text-black'> Login</button>
            <button className='text-sm font-medium text-almost-gray py-2 px-4 rounded-lg border-2 hover:text-black hover:border-black'> Register</button>
           </div>

           <div className={menu ? 'hidden' :'flex sm:flex md:hidden'} onClick={()=>controlMenu()}>
           <svg  class="w-8 text-almost-dark hover:text-gray-600" fill="currentColor" stroke="none" viewBox="0 0 32 18">
           <g ><path d="M0 0h32v2H0zM0 8h32v2H0zM0 16h32v2H0z"/></g>
           </svg>
           </div>

           <div className={menu ? 'flex md:hidden sm:flex z-50' :'hidden z-50'} onClick={()=>controlMenu()}>
           

           <svg  class="w-8 text-almost-dark hover:text-gray-600" fill="currentColor" stroke="none" viewBox="0 0 32 32">
           <g ><path d="m2.393.98 22.628 22.628-1.414 1.414L.979 2.395z"/><path d="M.98 23.607 23.609.979l1.414 1.414L2.395 25.021z"/>
           </g>
           </svg>
        ...
        <div className='hidden flex-row gap-8 ml-16 sm:hidden md:flex'>
        {features ? 
           <div className='fixed p-6  flex flex-col gap-3 bg-white shadow-xl rounded-lg'> 
           <div className='flex flex-row gap-2'>
           <svg width="14" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M14 3v12a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h1V1a1 1 0 1 1 2 0v1h2V1a1 1 0 1 1 2 0v1h2V1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 1 1Zm-2 3H2v1h10V6Zm0 3H2v1h10V9Zm0 3H2v1h10v-1Z" fill="#726CEE"/></svg>            <h1 className='text-sm font-medium text-almost-gray'>Todo list</h1>
            </div> 
        ...
        :''}
            ...
            {company ? 
           <div className='fixed left-60 p-6 h-32 flex flex-col gap-3 bg-white shadow-xl rounded-lg'> 
           <h1 className='text-sm font-medium text-almost-gray hover:text-black'>History</h1>
           <h1 className='text-sm font-medium text-almost-gray hover:text-black'>Our Team</h1>
           <h1 className='text-sm font-medium text-almost-gray hover:text-black'>Blog</h1>
            </div>
            :''}
       ...
       {menu ? 
        <div>
        <div className=' absolute top-0 right-0 sm:flex flex md:hidden  z-40 bg-almost-white h-screen w-56'>
            <div className='flex flex-col gap-2  items-start  p-4 mt-32'>
            <button onClick={()=>controlFeaturesL()} className='flex flex-row gap-3 items-center text-sm font-medium text-almost-gray hover:text-black' >Features 
            {featuresL ?<svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg> :  <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>}
            </button> 
           ...
           <div className='flex flex-row gap-2'>
            ...
            <button onClick={()=>controlCompanyL()} className='flex flex-row gap-3 items-center text-sm font-medium text-almost-gray hover:text-black'>Company
            {companyL ?<svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg> :  <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>}
            </button>
        ...
        <div className='w-screen h-screen p-8 top-0 left-0 bg-black opacity-70 absolute flex sm:flex md:hidden '>
